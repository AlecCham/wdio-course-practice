...
if (process.env.TEST_ENV === 'browserstack') {
    ...
    capabilities = [
        // Define your BrowserStack capabilities here
    ];
} else {
    // Define local service configuration if needed, e.g., for Selenium standalone
    // services.push(['selenium-standalone']);
    capabilities = [
        // Define your local testing capabilities here
        { browserName: 'chrome' }
    ];
}
